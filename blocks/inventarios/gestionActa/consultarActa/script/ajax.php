...
$cadenaACodificar .= "&bloqueNombre=" . $esteBloque ["nombre"];
$cadenaACodificar .= "&bloqueGrupo=" . $esteBloque ["grupo"];
$cadenaACodificar .= "&funcion=consultarUbicacion";
$cadenaACodificar .= "&tiempo=" . $_REQUEST ['tiempo'];
...
// URL definitiva
$urlConsultaUbicacion = $url . $cadena;
...
function consultarEspacioConsulta(elem, request, response){
	  $.ajax({
	    url: "<?php echo $urlConsultaUbicacion?>",
	    dataType: "json",
	    data: { dependencia:$("#<?php echo $this->campoSeguro('dependenciaConsulta')?>").val(),
	            sede:$("#<?php echo $this->campoSeguro('sedeConsulta')?>").val()},
	    success: function(data){ 
	        if(data[0]!=" "){

	            $("#<?php echo $this->campoSeguro('ubicacionConsulta')?>").html('');
	            $("<option value=''>Seleccione  ....</option>").appendTo("#<?php echo $this->campoSeguro('ubicacionConsulta')?>");
	            $.each(data , function(indice,valor){

	            	$("<option value='"+data[ indice ].ESF_ID_ESPACIO+"'>"+data[ indice ].ESF_NOMBRE_ESPACIO+"</option>").appendTo("#<?php echo $this->campoSeguro('ubicacionConsulta')?>");
	            	
	            });
	            
	            $("#<?php echo $this->campoSeguro('ubicacionConsulta')?>").removeAttr('disabled');
    ...
    $(function () {
        ...
        $("#<?php echo $this->campoSeguro('dependenciaConsulta')?>").change(function(){
        	if($("#<?php echo $this->campoSeguro('dependenciaConsulta')?>").val()!=''){
    			...
    			$("#<?php echo $this->campoSeguro('ubicacionConsulta')?>").attr('disabled','');
    			}
